...
export const DEFAULT_CDT_TABLES: Record<number, number[]> = {
    3.2:
        [
            65535, 63963, 60395, 55305, 49438, 43597, 38341, 33914, 30338, 27508, 25235, 23401, 21897, 20628
        ],
    178.56:
        [
            65535, 65534, 65533, 65530, 65525, 65520, 65510, 65500, 65480, 65450, 65400, 65350, 65280, 65200,
            65100, 64980, 64850, 64700, 64500, 64300, 64100, 63900, 63650, 63400, 63100, 62800, 62500, 62150,
            61800, 61400, 61000, 60500, 60000, 59500, 59000, 58400, 57800, 57200, 56600, 56000, 55300, 54600,
            53900, 53200, 52500, 51800, 51100, 50400, 49700, 49000, 48300, 47600, 46900, 46200, 45500, 44800,
            44100, 43400, 42700, 42000, 41300, 40600, 39900, 39200, 38500, 37800, 37100, 36400, 35700, 35000,
            34300, 33600, 32900, 32200, 31500, 30800, 30100, 29400, 28700, 28000, 27300, 26600, 25900, 25200,
            24500, 23800, 23100, 22400, 21700, 21000, 20300, 19600, 18900, 18200, 17500, 16800, 16100, 15400,
            14700, 14000, 13300, 12600, 11900, 11200, 10500, 9800, 9100, 8400, 7700, 7000, 6300, 5600, 4900,
            4200, 3500, 2800, 2100, 1400, 700, 350, 175, 87, 43, 21, 10, 5, 2, 1
        ]
};
