...
describe('Crypto Class', () => {
  ...
  describe('randPrime()', () => {
    ...
    describe('basic functionality', () => {
      test('should return a BigInt', () => {
        const result = Crypto.randPrime(32, 41, true); // Small bit size for faster tests
    ...
    describe('security properties', () => {
      test('should generate different primes on multiple calls', () => {
        const prime1 = Crypto.randPrime(32, 41, true);
        const prime2 = Crypto.randPrime(32, 41, true);
    ...
    describe('RSA key generation', () => {
      test('should generate primes suitable for RSA key generation', () => {
        ...
        do {
          p = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
          q = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
      ...
      test('should handle edge cases for RSA parameter validation', () => {
        const p = Crypto.randPrime(128, 41, true);
        const q = Crypto.randPrime(128, 41, true);
        const n = p * q;
        const phi = (p - 1n) * (q - 1n);
        const e = 65537n;
        ...
        const largePrime = Crypto.randPrime(256, 41, true);
        if (largePrime >= n) {
      ...
      test('should handle RSA signature verification with wrong public key', () => {
        ...
        // Loop to ensure modulus n is of the expected bit length
        do {
          p1 = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
          q1 = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
        ...
        // Loop to ensure modulus n is of the expected bit length
        do {
          p2 = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
          q2 = Crypto.randPrime(expectedBitLength, 41, true); // Increase the iterations to 41 and see how it goes. 🎰🎰🎰
  ...
  describe('randPrime bit length tests', () => {
    ...
    test('should regenerate primes if bit length is not as expected', () => {
      ...
      const prime = Crypto.randPrime(256, 41, true);
