...
describe('Crypto Class', () => {
  ...
  describe('randPassword()', () => {
    ...
    it('should handle large passwords efficiently', () => {
      ...
      // We need to increase this now because the average of 1k is set to 999 due to different hardware.
      // However, on my local machine (Ubuntu 25.04 (Plucky Puffin)), it's less than 350.
      expect(end - start).toBeLessThan(999); // Increased from 700 to 999 because 500 fails on Windows, haha.
    });
  ...
  describe('randLattice()', () => {
    ...
    test('should work with custom CDT table', () => {
      ...
      // This ensures uniqueness and is comparable with random bytes
      const resultSigma178_56 = Crypto.randLattice(1024, 16777213, 178.56, 'normalized', customCDT);
